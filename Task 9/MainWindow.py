...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self) -> None:
        ...
        self.detector_widgets: dict[str, QtWidgets.QWidget] = {'Harris': HarrisDetectorWidget(main_window=self),
                                                               'Tomachi': TomachiDetectorWidget(main_window=self)}
    ...
    @pyqtSlot()
    def show_harris_widget(self) -> None:
        self.close_current_widget()
        self.current_widget = self.detector_widgets["Harris"]
